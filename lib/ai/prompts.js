...
function buildSystemPrompt(selectedContext, mode) {
  const base = 
    ...
    "TU REGLA MÁS IMPORTANTE: DEBES RESPONDER SIEMPRE Y ÚNICAMENTE EN ESPAÑOL RIOPLATENSE (voseo), BAJO NINGUNA CIRCUNSTANCIA RESPONDAS EN INGLÉS, incluso si el usuario usa términos en inglés. " +
    "Cuando recibas archivos o imágenes, razoná sobre su contenido y respondé exactamente lo que el usuario pida en español.";
